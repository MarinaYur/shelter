...
const slider = () => {
    ...
    // console.log((Array.from(pets[currentPet].children).length));
    
    // console.log(pets[1]);
    // console.log(petsCollection[5]);
    let currentPet = 0;
    // let currentBlock
    let isEnabled = true; 
    ...
    console.log(block[1]);
 // //    let petBlock = document.querySelector('.slider__pets .block');
 // //    petBlock.innerHTML = block;
 // //    console.log(petBlock);
    ...
    currentPet = (n + pets.length) % pets.length;
        // // console.log(pets[currentPet-1]);
        // if(Array.from((pets[currentPet].children).length === 2)) {
            ...
            //         pet.innerHTML = petsCollection[k].innerHTML;
            //         k++;
                    
            //     }
            //         // console.log(pets[i]);
            //         // pets[i][j].innerHTML = petsCollection[k].;
            //         // k++;
            // })
            // // currentPet = (n + pets.length) % pets.length;
        //    console.log(petsCollection[2]);
        //    let i = 0;
        //    pets.forEach(pet => {
        //        let block = [];
        //        for (i ; i <= 2; i ++){
        //            block.push(petsCollection[i]);
        //        }
        //        pet.innerHTML = block;
        //        i = 0;
        //    })
    ...
    function showPet(direction) {
        // console.log(Array.from(pets[currentPet].children));
        // if (Array.from(pets[currentPet].children.length < 3) {
